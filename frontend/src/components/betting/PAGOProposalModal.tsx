// frontend/src/components/betting/PAGOProposalModal.tsx
// Modal for creating PAGO proposals between users
...
interface PAGOProposalModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (proposal: {
    fightId: string;
...
const PAGOProposalModal: React.FC<PAGOProposalModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  fightId,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.targetUserId === currentUserId) {
        throw new Error("No puedes hacerte PAGO a ti mismo");
      }
  ...
  return (
    <Modal title="Propuesta PAGO" isOpen={isOpen} onClose={onClose} size="md">
...
export default PAGOProposalModal;
