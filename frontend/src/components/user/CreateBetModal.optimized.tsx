        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`flex items-center justify-center gap-2 py-3 rounded-xl transition-all duration-200 ${
                  side === "red"
                    ? "bg-red-500/20 border-2 border-red-500 text-red-400 font-medium shadow-md"
          ...
          <div className="space-y-3">
            <button
              ...
              className="flex items-center justify-between w-full p-3 bg-[#2a325c] rounded-xl border border-[#596c95] text-gray-300 hover:bg-[#596c95]/20 transition-all duration-200"
            >
            ...
            {showAdvanced && (
              <div className="space-y-4 p-4 bg-[#2a325c] rounded-xl border border-[#596c95]">
                  ...
                  <div className="pt-3 border-t border-[#596c95]">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-[#2a325c] text-white p-3 pl-10 rounded-xl border border-[#596c95] focus:outline-none focus:ring-2 focus:ring-[#cd6263] focus:border-transparent transition-all duration-200"
                        required
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-3 bg-gray-600 hover:bg-gray-700 text-white rounded-xl transition-all duration-200 font-medium shadow-sm hover:shadow-md"
            >
              Cancelar
            </button>
            <button
          ...
          <div className="mt-2 pt-4 border-t border-[#596c95]">
            ...
            <div className="space-y-2 max-h-48 overflow-y-auto">
              {suggestions.map((bet) => (
                <div
                  key={bet.id}
                  className="flex justify-between items-center p-3 bg-[#2a325c] rounded-xl border border-[#596c95] hover:bg-[#596c95]/20 transition-all duration-200"
                >
                  <div>
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-[#596c95] hover:bg-[#596c95]/80 text-white rounded-lg text-sm transition-all duration-200 shadow-sm hover:shadow-md"
                  >
                    Proponer PAGO
                  </button>
                </div>
