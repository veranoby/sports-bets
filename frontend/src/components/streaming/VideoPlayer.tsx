...
const VideoPlayer: React.FC<VideoPlayerProps> = (props) => {
  ...
  if (!isAccessChecked || membershipLoading) {
    return (
      <div
        className={`relative bg-black rounded-lg overflow-hidden flex items-center justify-center ${props.className || "h-96"}`}
      >
        ...
        >
          <div className="text-center text-white">
            ...
            <p className="text-gray-400 mb-4">
              Necesitas una membresía activa para ver este contenido.
            </p>
            <button
        ...
        >
          <div className="text-center mb-6">
            ...
            <h3 className="text-lg font-semibold mb-2">
              Accede a Eventos en Vivo Premium
            </h3>
            <p className="text-gray-600">
              Mejora tu membresía para ver todos los eventos en vivo sin
              interrupciones.
            </p>
          </div>
          <PaymentProofUpload
            onUploadSuccess={() => {
              ...
              notification.success({
                message:
                  "Comprobante subido con éxito! El administrador activará tu membresía.",
              });
            }}
          />
        </Modal>
