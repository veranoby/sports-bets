...
// Componente de tarjeta de artículo premium con indicadores visuales

import React from "react";
import { Calendar, Eye, User, FileText, Crown, Lock } from "lucide-react";
...
const PremiumArticleCard: React.FC<PremiumArticleCardProps> = ({
  article,
