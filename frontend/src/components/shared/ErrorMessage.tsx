...
const ErrorMessage: React.FC<ErrorMessageProps> = ({
  ...
  const isFeatureDisabled =
    displayMessage.toLowerCase().includes("currently disabled") ||
    displayMessage
      .toLowerCase()
      .includes("wallet system is currently disabled");
        ...
        <div className="flex items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-yellow-700 mb-3">
              El sistema de billeteras está temporalmente deshabilitado por el
              administrador.
            </p>
            <div className="flex items-center text-xs text-yellow-600">
              <Lock className="w-4 h-4 mr-1" />
              Contacta al administrador del sistema para habilitar esta
              funcionalidad.
            </div>
          </div>
        </div>
