...
const StatusChip: React.FC<StatusChipProps> = ({
  ...
  const statusConfig = {
    ...
    draft: {
      ...
      indicator: { color: "bg-gray-400", textColor: "text-gray-500", pulse: false },
    },
    scheduled: {
      chip: "bg-blue-100 text-blue-800",
      indicator: { color: "bg-blue-500", textColor: "text-blue-600", pulse: false },
    },
    ready: {
      chip: "bg-yellow-100 text-yellow-800",
      indicator: { color: "bg-yellow-500", textColor: "text-yellow-600", pulse: true },
    },
    betting_open: {
      chip: "bg-green-100 text-green-800",
      indicator: { color: "bg-green-500", textColor: "text-green-600", pulse: true },
    },
    in_progress: {
      chip: "bg-red-100 text-red-800",
      indicator: { color: "bg-red-500", textColor: "text-red-600", pulse: true },
    },
    completed: {
      chip: "bg-purple-100 text-purple-800",
      indicator: { color: "bg-purple-500", textColor: "text-purple-600", pulse: false },
    },
    cancelled: {
      chip: "bg-gray-200 text-gray-800",
      indicator: { color: "bg-gray-400", textColor: "text-gray-500", pulse: false },
    ...
    approved: {
      ...
      indicator: { color: "bg-green-500", textColor: "text-green-600", pulse: false },
    },
    settled: {
      chip: "bg-green-500/20 text-green-500",
      indicator: { color: "bg-green-500", textColor: "text-green-600", pulse: false },
    ...
    processing: {
      chip: "bg-blue-100 text-blue-800",
      indicator: { color: "bg-blue-500", textColor: "text-blue-600", pulse: true },
    },
    connecting: {
      chip: "bg-yellow-100 text-yellow-800",
      indicator: { color: "bg-yellow-500", textColor: "text-yellow-400", pulse: true },
