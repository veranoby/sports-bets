"use strict";
describe('Operator Workflow', function () {
    beforeEach(function () {
    ...
    it('should display a restricted navigation menu for operators', function () {
    ...
    it('should display only assigned events in the event management page', function () {
    ...
    it('should display only venue and gallera users in the user management page', function () {
    ...
    it('should not allow access to admin-only pages', function () {
