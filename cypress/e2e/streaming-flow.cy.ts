describe('Complete Streaming Flow - OBS to User', () => {
  beforeEach(() => {
  ...
  describe('Operator Stream Setup', () => {
    it('should allow operator to start a new stream', () => {
      // Login as operator
    ...
    it('should show real-time stream analytics', () => {
      cy.login('operator', 'operator@test.com', 'testpassword')
      cy.visit('/operator/stream')
    ...
    it('should handle stream interruptions gracefully', () => {
      cy.login('operator', 'operator@test.com', 'testpassword')
      cy.visit('/operator/stream')
    ...
    it('should stop stream properly', () => {
      cy.login('operator', 'operator@test.com', 'testpassword')
      cy.visit('/operator/stream')
  ...
  describe('User Stream Viewing', () => {
    it('should allow subscribed users to watch stream', () => {
    ...
    it('should show subscription prompt for non-subscribed users', () => {
  ...
  describe('Stream Quality and Performance', () => {
    it('should automatically adjust quality based on connection', () => {
      cy.login('user', 'user@test.com', 'testpassword', {
        subscription: { type: 'daily', status: 'active' }
      })
    ...
    it('should show buffering indicator during slow loads', () => {
      cy.login('user', 'user@test.com', 'testpassword', {
        subscription: { type: 'daily', status: 'active' }
      })
...
// Custom command definitions (to be added to support/commands.ts)
declare global {
  namespace Cypress {
    interface Chainable {
      login(role: string, email: string, password: string, options?: any): Chainable<void>
    }
  }
}