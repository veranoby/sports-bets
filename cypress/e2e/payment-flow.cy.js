"use strict";
describe('Payment Flow E2E', function () {
    beforeEach(function () {
        // Mock Kushki SDK
    ...
    describe('Subscription Purchase Flow', function () {
        it('completes monthly subscription purchase successfully', function () {
            ...
            // Select monthly plan
            cy.get('[data-testid="plan-monthly"]').within(function () {
        ...
        it('handles payment validation errors', function () {
            cy.visit('/subscriptions');
            // Select monthly plan
            cy.get('[data-testid="plan-monthly"]').within(function () {
                cy.contains('Select Plan').click();
        ...
        it('handles invalid card number', function () {
            cy.visit('/subscriptions');
            cy.get('[data-testid="plan-monthly"]').within(function () {
                cy.contains('Select Plan').click();
            });
        ...
        it('purchases daily subscription', function () {
            cy.visit('/subscriptions');
            // Select daily plan
            cy.get('[data-testid="plan-daily"]').within(function () {
                cy.contains('Select Plan').click();
            });
    ...
    describe('Subscription Management', function () {
        ...
        it('displays payment history', function () {
        ...
        it('upgrades from daily to monthly plan', function () {
    ...
    describe('Access Control', function () {
        it('blocks premium content for non-subscribers', function () {
        ...
        it('allows premium content for active subscribers', function () {
            // Mock active subscription
            cy.intercept('GET', '/api/subscriptions/current', {
                statusCode: 200,
                body: {
        ...
        it('blocks expired subscription access', function () {
    ...
    describe('Mobile Responsiveness', function () {
        ...
        it('displays subscription plans correctly on mobile', function () {
            cy.visit('/subscriptions');
        ...
        it('payment form works on mobile', function () {
            cy.visit('/subscriptions');
            cy.get('[data-testid="plan-monthly"]').within(function () {
                cy.contains('Select Plan').click();
            });
