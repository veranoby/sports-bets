...
router.get("/", auth_1.optionalAuth, (0, errorHandler_1.asyncHandler)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, limit, _c, offset, ownerApproved, ownerSubscription, search, userRole, cacheKey, data;
    var _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                _a = req.query, _b = _a.limit, limit = _b === void 0 ? 20 : _b, _c = _a.offset, offset = _c === void 0 ? 0 : _c, ownerApproved = _a.ownerApproved, ownerSubscription = _a.ownerSubscription, search = _a.search;
                userRole = ((_d = req.user) === null || _d === void 0 ? void 0 : _d.role) || 'public';
                cacheKey = "venues:list:".concat(userRole, ":").concat(ownerApproved || 'all', ":").concat(ownerSubscription || 'all', ":").concat(search || 'all', ":").concat(limit, ":").concat(offset);
                            ...
                            switch (_o.label) {
                                ...
                                case 1:
                                    ...
                                    transformedRows = rows.map(function (user) {
                                        ...
                                        return {
                                            id: user.id,
                                            name: profile.venueName || user.username,
                                            location: profile.venueLocation || '',
                                            description: profile.venueDescription || '',
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                cacheKey = "venue:".concat(req.params.id, ":").concat(userRole);
                return [4 /*yield*/, (0, redis_1.getOrSet)(cacheKey, function () { return __awaiter(void 0, void 0, void 0, function () {
                        var user, profile, calculatedStatus, venueData;
